...
Imbalanced Fracture Detection</h3>
            ...
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
            <h3 className="text-xl font-bold mb-2">[New Project Title]</h3>
            <p className="text-gray-400 mb-4">
              [Your new project description goes here. For example: "Staff work efficiency monitoring using realtime pose detection with improved dashboard visualization."]
            </p>
            <div className="flex flex-wrap gap-2 mb-4">
            ...
            <div className="flex justify-between items-center">
              <a
                href="https://github.com/your-username/new-project"
                target="_blank"
