...
export const Certifications = () => {
  ...
  return (
    <section id="certifications" className="py-20 bg-[#0a041a] bg-opacity-90 relative">
        ...
        <RevealOnScroll>
          ...
          <div className="bg-blue-900/20 backdrop-blur-sm border border-blue-800/50 rounded-2xl p-8 shadow-lg max-w-5xl mx-auto">
            <p className="text-gray-300 mb-8 text-center">
              Professional certifications that validate my expertise in AI, machine learning, and software development.
            </p>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {certificationsList.map((cert) => (
                ...
                >
                  ...
                  <div className="absolute inset-0 flex flex-col justify-end p-6 transform transition-transform duration-500 ease-in-out group-hover:-translate-y-2">
                    <h3 className="text-xl font-bold text-white mb-2 group-hover:text-blue-300 transition-colors">
                      {cert.title}
                    </h3>
                    
                    {/* Expandable description that appears on hover */}
                    <div className="overflow-hidden transition-all duration-500 ease-in-out max-h-0 group-hover:max-h-40">
                      <p className="text-gray-300 text-sm mb-3">
                        This certification validates technical skills and expertise in {cert.title.toLowerCase()}.
                      </p>
                      <a 
                        href={cert.link} 
                        target="_blank" 
